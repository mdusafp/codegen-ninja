        ...
        <Content>
          ...
          <Search>
            <Searchinput>
              <SearchinputInner>
                <GroupParent>
                  <GroupIcon alt="" src="/assets/group1.svg" />
            ...
            <Filters>
              <Calendar1>
                ...
                <IconArrowDown1 alt="" src="/assets/-icon-arrow-down-11.svg" />
              </Calendar1>
              <Calendar1>
              ...
              <Checkbox1>
                <IconMoreSquare alt="" src="/assets/-icon-more-square.svg" />
                <Div>Joined</Div>
              </Checkbox1>
            </Filters>
          </Search>
          <AccountIcon alt="" src="/assets/account1.svg" />
        </Content>
      </Box>
    </Property1defaultRoot>
  );
